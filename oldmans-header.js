(function () {
  ...
  /* =====================================================
     ...
     Verze: 3.9 — Košík: pruh dopravy restylovaný (klientská verze), částka bez zelené
     ===================================================== */
  ...
  function enhanceCartPage() {
    ...
    /* 1b. Přepis textu podle WP reference (20. 7. 2026): nativní
       ...
       zůstávají nedotčené. Idempotentní — po přepisu už fráze v textu
       nejsou, druhé volání nic nezmění.
       OPRAVA (21. 7. 2026, na žádost klienta): dřív se první strong
       s "Kč" označoval třídou .om-delivery-amount pro zelenou barvu —
       odstraněno, částka zůstává černá jako zbytek textu (CSS teď má
       jen obecné pravidlo #cart-wrapper .extra.delivery strong). */
    if (deliveryEl) {
